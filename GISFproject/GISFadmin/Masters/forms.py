...
from .models import XxgenProductMaster, XxgenProductRiskMaster, XxgenAgenMaster, Xxgen_agent_Prod_Comm_Master, \
    XxgenVehicleMaster, XxgenVehicleDepriciation, XxgenNcbMaster, XxgenClaimStatusMaster
...
class ProductRiskForm(forms.ModelForm):
    ...
    risk_description = forms.CharField(required=True,
                                       widget=forms.TextInput(attrs={"size": 10, 'style': 'width:100px'}))
...
from .models import XxgenClaimsSurveyorMaster
