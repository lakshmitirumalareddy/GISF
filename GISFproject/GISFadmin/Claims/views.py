...
class SubmitedClaimListView(ListView):
    template_name = 'Claims/XxgenClaims_list.html'
...
class SurveyorClaimListView(ListView):
    template_name = 'Claims/XxgenClaimsSurveyorDtls_list.html'
    queryset = XxgenClaimsSurveyorDtls.objects.filter(
        clm_survey_status__in=['UNDERSURVEY', 'SURVEYORASSIGNED', 'DOCUMENTPENDING'])


class PaymentPendingClaimListView(ListView):
    template_name = 'Claims/XxgenClaimsProcessDtls_list.html'
